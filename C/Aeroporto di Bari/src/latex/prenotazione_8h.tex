...
\begin{DoxyCompactItemize}
\item 
int \hyperlink{prenotazione_8h_a04c3d07188feef0e4b16f8a5292c0e71}{prenota\+Volo} (F\+I\+LE $\ast$voli, F\+I\+LE $\ast$passeggeri)
...
int \hyperlink{prenotazione_8h_a045510394d1e05fa2d7254f2fc494162}{modifica\+Prenotazione} (F\+I\+LE $\ast$passeggeri, int id\+\_\+utente)
\item 
int \hyperlink{prenotazione_8h_a315fbf4481da0e8f9075a610eb219628}{checkin} (F\+I\+LE $\ast$voli, F\+I\+LE $\ast$passeggeri)
\item 
int \hyperlink{prenotazione_8h_a86dda93023d5f1b60ae34d6b92c5842b}{ricerca\+Prenotazione} (F\+I\+LE $\ast$passeggeri)
\item 
int \hyperlink{prenotazione_8h_a8a5ffb8f9d9f058d61caf2264d08162a}{ordinamento\+Prenotazioni} (F\+I\+LE $\ast$passeggeri)
\end{DoxyCompactItemize}
...
Questa libreria contiene essenzialmente la struct per la prenotazione e varie funzioni riguardanti essa (prenotazione del volo e check-\/in) \begin{DoxyVersion}{Versione}
1 
\end{DoxyVersion}
\begin{DoxyDate}{Data}
13/05/2019 
...
\mbox{\Hypertarget{prenotazione_8h_a315fbf4481da0e8f9075a610eb219628}\label{prenotazione_8h_a315fbf4481da0e8f9075a610eb219628}} 
\index{prenotazione.\+h@{prenotazione.\+h}!checkin@{checkin}}
\index{checkin@{checkin}!prenotazione.\+h@{prenotazione.\+h}}
...
Questa procedura apre l\textquotesingle{}interfaccia per il check-\/in del volo. Ulteriori funzioni/controlli saranno implementati all\textquotesingle{}interno.
...
La funzione ritorna 1, se il check-\/in è stato effettuato con successo, ritorna 0 se il check-\/in non è stato effettuato, data la mancanza del file dei passeggeri.
\end{DoxyReturn}
...
Gli assegno 1, in modo tale che nel caso in cui l\textquotesingle{}utente dovesse rifare il check-\/in, non gli sarà permesso dato che il controllo del check-\/in per questa prenotazione è impostato ad 1. \mbox{\Hypertarget{prenotazione_8h_a045510394d1e05fa2d7254f2fc494162}\label{prenotazione_8h_a045510394d1e05fa2d7254f2fc494162}} 
\index{prenotazione.\+h@{prenotazione.\+h}!modifica\+Prenotazione@{modifica\+Prenotazione}}
\index{modifica\+Prenotazione@{modifica\+Prenotazione}!prenotazione.\+h@{prenotazione.\+h}}
...
Questa procedura apre l\textquotesingle{}interfaccia per la modifica di una prenotazione. Ulteriori funzioni/controlli saranno implementati all\textquotesingle{}interno.


\begin{DoxyParams}{Parametri}
{\em passeggeri} & File dei passeggeri \\
\hline
{\em id\+\_\+utente} & E\textquotesingle{} l\textquotesingle{}ID dell\textquotesingle{}utente che intende modificare la prenotazione\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Restituisce}
La funzione ritorna 1, se la modifica della prenotazione è stata effettuata con successo, ritorna 0 se la modifica non è stata effettuata, data la mancanza del file dei passeggeri.
\end{DoxyReturn}
...
Qui ricadranno tutti i valori non corretti. (caratteri e num $>$ 9). \mbox{\Hypertarget{prenotazione_8h_a8a5ffb8f9d9f058d61caf2264d08162a}\label{prenotazione_8h_a8a5ffb8f9d9f058d61caf2264d08162a}} 
\index{prenotazione.\+h@{prenotazione.\+h}!ordinamento\+Prenotazioni@{ordinamento\+Prenotazioni}}
\index{ordinamento\+Prenotazioni@{ordinamento\+Prenotazioni}!prenotazione.\+h@{prenotazione.\+h}}
...
Questa procedura apre il file degli utenti e ordina in base al nome tutti le prenotazioni.
...
Non stampare utenti cancellati. \mbox{\Hypertarget{prenotazione_8h_a04c3d07188feef0e4b16f8a5292c0e71}\label{prenotazione_8h_a04c3d07188feef0e4b16f8a5292c0e71}} 
\index{prenotazione.\+h@{prenotazione.\+h}!prenota\+Volo@{prenota\+Volo}}
\index{prenota\+Volo@{prenota\+Volo}!prenotazione.\+h@{prenotazione.\+h}}
...
Questa procedura apre l\textquotesingle{}interfaccia per la prenotazione del volo. Ulteriori funzioni/controlli saranno implementati all\textquotesingle{}interno.
...
\end{DoxyParams}
\begin{DoxyReturn}{Restituisce}
La funzione ritorna 1, se la prenotazione è stata effettuata con successo, ritorna 0 se la prenotazione non è stata effettuata, data la mancanza del file dei passeggeri.
\end{DoxyReturn}
...
Chiudo tutti i file aperti. \mbox{\Hypertarget{prenotazione_8h_a86dda93023d5f1b60ae34d6b92c5842b}\label{prenotazione_8h_a86dda93023d5f1b60ae34d6b92c5842b}} 
\index{prenotazione.\+h@{prenotazione.\+h}!ricerca\+Prenotazione@{ricerca\+Prenotazione}}
\index{ricerca\+Prenotazione@{ricerca\+Prenotazione}!prenotazione.\+h@{prenotazione.\+h}}
...
Questa procedura apre l\textquotesingle{}interfaccia per la ricerca di una prenotazione. Ulteriori funzioni/controlli saranno implementati all\textquotesingle{}interno.
...
\end{DoxyParams}
\begin{DoxyReturn}{Restituisce}
La funzione ritorna 1, se la ricerca della prenotazione è stata effettuata con successo, ritorna 0 se la prenotazione non esiste, oppure il file dei passeggeri non è presente.
\end{DoxyReturn}
