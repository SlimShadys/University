\hypertarget{amministratore_8h}{}\section{Riferimenti per il file amministratore.\+h}
\label{amministratore_8h}\index{amministratore.\+h@{amministratore.\+h}}
\subsection*{Funzioni}
\begin{DoxyCompactItemize}
\item 
void \hyperlink{amministratore_8h_a7172ac0d3bdb443a3a6a13882b3a3133}{login\+\_\+amministratore} ()
\item 
int \hyperlink{amministratore_8h_a3e0ee854c6242b6669da7c40acdfab89}{chiudi\+\_\+checkin} ()
...
Prototipi di funzioni per i task dell\textquotesingle{}amministratore.

Questa libreria contiene essenzialmente due funzioni relative all\textquotesingle{}amministratore nonchè, il suo login e la chiusura del check-\/in. \begin{DoxyVersion}{Versione}
1 
\end{DoxyVersion}
\begin{DoxyDate}{Data}
13/05/2019 
...
\mbox{\Hypertarget{amministratore_8h_a3e0ee854c6242b6669da7c40acdfab89}\label{amministratore_8h_a3e0ee854c6242b6669da7c40acdfab89}} 
\index{amministratore.\+h@{amministratore.\+h}!chiudi\+\_\+checkin@{chiudi\+\_\+checkin}}
\index{chiudi\+\_\+checkin@{chiudi\+\_\+checkin}!amministratore.\+h@{amministratore.\+h}}
...
Questa funzione chiude il check-\/in. Per poter funzionare non ha bisogno di parametri in entrata.

\begin{DoxyReturn}{Restituisce}
La funzione ritorna 1, se la chiusura è stata effettuata con successo, ritorna 0 se la chiusura non è stata effettuata.
\end{DoxyReturn}
...
Stampa un errore non appena la prima if (relativa alla lunghezza) è falsa. \mbox{\Hypertarget{amministratore_8h_a7172ac0d3bdb443a3a6a13882b3a3133}\label{amministratore_8h_a7172ac0d3bdb443a3a6a13882b3a3133}} 
\index{amministratore.\+h@{amministratore.\+h}!login\+\_\+amministratore@{login\+\_\+amministratore}}
\index{login\+\_\+amministratore@{login\+\_\+amministratore}!amministratore.\+h@{amministratore.\+h}}
...
Questa procedura apre l\textquotesingle{}interfaccia per il login amministratore. Ulteriori funzioni saranno implementate all\textquotesingle{}interno. La funzione ha codice F01a
