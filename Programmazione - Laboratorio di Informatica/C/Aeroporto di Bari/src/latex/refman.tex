...
\vspace*{7cm}
\begin{center}%
{\Large Aeroporto di Bari -\/ Gruppo 21 \\[1ex]\large 1.\+0 }\\
\vspace*{1cm}
...
\input{structdata}
\input{structpasseggero}
\input{structprenotazione}
\input{structvolo}
\chapter{Documentazione dei file}
\input{_aeroporto_01di_01_bari_8c}
\input{amministratore_8c}
\input{amministratore_8h}
\input{controlli_8c}
\input{controlli_8h}
\input{data_8h}
\input{define_8h}
...
\input{passeggero_8c}
\input{passeggero_8h}
\input{prenotazione_8c}
\input{prenotazione_8h}
\input{volo_8c}
\input{volo_8h}
