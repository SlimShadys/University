...
public class Studente implements Serializable, Comparable<Studente>{ //IMPLEMENTS SERIALIZABLE ALTRIMENTI NON FUNZIONA
	...
	private static Set<Studente> studenti_array = new TreeSet<Studente>();
	...
	public static void print() throws ClassNotFoundException {
		...
		try {
			...
			while (fileInput.available() > 0) {
				...
				/*
				 * StreamInput.readObject(), leggerà un oggetto di tipo Set<Studente> e
				 * lo immagazzinerà nel set. Farà così per tutti gli oggetti, finchè il file
				 * non finisce
				 */
				Set<Studente> array = (Set<Studente>) StreamInput.readObject();
